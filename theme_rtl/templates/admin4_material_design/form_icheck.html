...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-shadow note-danger">
						<p>
							 To use iCheck checkbox and radio controls just apply <code>icheck</code> class to any checkbox or radio input and set the control style and color <br>
							 via HTML attributes <code>data-checkbox="icheckbox_minimal-grey"</code> or <code>data-radio="iradio_flat-grey"</code> and Metronic will take care of the plugin initialization.
						</p>
						<p>
							 This plugins is not included with the core plugins so if you like to use it you just need to include following js and css files on your page:<br>
							<br>
							<code>../../assets/global/plugins/icheck/skins/all.css</code><br>
							<code>../../assets/global/plugins/icheck/icheck.min.js</code>
						</p>
						<p>
							 For more info please chech the plugin's official documentation <a href="http://fronteed.com/iCheck/" target="_blank">http://fronteed.com/iCheck/</a>
						</p>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="portlet light">
								<div class="portlet-title tabbable-line">
									...
									<ul class="nav nav-tabs">
										...
										<li>
											<a href="#portlet_tab_1_2" data-toggle="tab">
											Square </a>
										</li>
										<li>
											<a href="#portlet_tab_1_3" data-toggle="tab">
											Flat </a>
										</li>
										<li>
											<a href="#portlet_tab_1_4" data-toggle="tab">
											Line </a>
										</li>
									</ul>
								</div>
													...
													<div class="form-body">
														...
														<div class="form-group">
															...
															<div class="input-group">
																<div class="icheck-list">
																	<label>
																	<input type="checkbox" class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox 1">
																	</label>
																	<label>
																	<input type="checkbox" checked class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox 2">
																	</label>
																	<label>
																	<input type="checkbox" class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox 3">
																	</label>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="input-group">
																<div class="icheck-list">
																	<label>
																	<input type="radio" name="radio1" class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 1 ">
																	</label>
																	<label>
																	<input type="radio" name="radio1" checked class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 2">
																	</label>
																	<label>
																	<input type="radio" name="radio1" class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 3">
																	</label>
																</div>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="input-group">
																<div class="icheck-inline">
																	<label>
																	<input type="radio" name="radio2" class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 1">
																	</label>
																	<label>
																	<input type="radio" name="radio2" checked class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 2">
																	</label>
																	<label>
																	<input type="radio" name="radio2" class="icheck" data-radio="iradio_line-grey" data-label="Radio Button 3">
																	</label>
																</div>
															</div>
														</div>
							...
							<div class="portlet light">
								<div class="portlet-title tabbable-line">
									...
									<ul class="nav nav-tabs">
										...
										<li>
											<a href="#portlet_tab_2_3" data-toggle="tab">
											Flat </a>
										</li>
										<li>
											<a href="#portlet_tab_2_4" data-toggle="tab">
											Line </a>
										</li>
									</ul>
								</div>
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<div class="input-group">
																	<div class="icheck-list">
																		<label>
																		<input type="checkbox" class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox Button 1">
																		</label>
																		<label>
																		<input type="checkbox" checked class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox Button 2">
																		</label>
																		<label>
																		<input type="checkbox" class="icheck" data-checkbox="icheckbox_line-grey" data-label="Checkbox Button 3">
																		</label>
																	</div>
																</div>
															</div>
