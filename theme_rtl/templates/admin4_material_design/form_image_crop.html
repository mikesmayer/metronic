...
<link href="../../assets/admin/pages/css/image-crop-rtl.css" rel="stylesheet"/>
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Image Cropping <small>image cropping samples</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
						...
						<div class="tab-content">
									...
									<div class="col-md-7 responsive-1024">
										...
										<div>
											<h4>Animation/Transitions.</h4>
											 Demonstration of animateTo API method and transitions for bgColor and bgOpacity options. Color fading requires inclusion of John Resig's jQuery <a href="http://plugins.jquery.com/project/color">
											Color Animations </a>
							...
							<div class="tab-pane" id="tab_7">
								<p id="demo7">
									...
									This is an example of attaching Jcrop to a target that is not an image. You are now cropping a paragraph tag. </span>
								</p>
